function writeTrialSpecifications(filePath, strScriptFolderWM, iSession, strLeftRight, bCreateExtraTrials, trialSpecificationFile, trialSpecificationFileFormat, stimulusSpecifications, ...
    ...
    for iRun = 1:nRuns
        ...
        transferArrayToTemplateSceFile(strScriptFolderWM, strPathTemplateFile, strFilePathArrayData, strPathOutputSceFile, bCreateExtraTrials, strLeftRight);
