function setupParadigm(strExpDevice, iSession, strLeftRight, filePath, bCreateExtraTrials, dbPercNonAlertedTargets, strCond, iCond, strExpCond, strExpCondShort, ...
    ...
    circleParameters.radius = ceil(65 * getScalingFactorOldProjectorToProPixx());
    ...
    writeTrialSpecifications(filePath, iSession, strLeftRight, bCreateExtraTrials, trialSpecificationFile, trialSpecificationFileFormat, stimulusSpecifications, ...
