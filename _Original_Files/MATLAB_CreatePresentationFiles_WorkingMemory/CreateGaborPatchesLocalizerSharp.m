function CreateGaborPatchesLocalizerSharp()
    ...
    for iMode = 1:3
        ...
        %sigma = 22;    %10                         % gaussian standard deviation in pixels
        ...
        [ gauss ] = GetEnvelopeCurve( floor(0.25*imSize), floor(0.48*imSize), imSize );
