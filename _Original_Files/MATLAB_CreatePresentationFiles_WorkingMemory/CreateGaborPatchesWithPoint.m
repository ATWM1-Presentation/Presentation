function CreateGaborPatchesWithPoint()

    % http://www.icn.ucl.ac.uk/courses/MATLAB-Tutorials/Elliot_Freeman/html/gabor_tutorial.html

    strOutputFolder = '/Users/mmb/MEG/ATWM1/Presentation/PresentationExperiments_EXP8/Bitmaps/';
        ...
        for bAddFrame = [0 1]
            ...
            for iPhase = 1:length(vPhases)
                ...
                for iAngle = 1:180
                    ...
                    sigma = 10;    %8                         % gaussian standard deviation in pixels
                    ...
                    if bCircularGrating
                       strOutputPath = sprintf('%sgabor_circ.bmp', strOutputFolder);     
                        ...
                        if iPhase == 1
                            ...
                            strOutputPath = sprintf('%sgabor_%03d_inv.bmp', strOutputFolder, iAngle);
                        end
                    end
                    ...
                    %strOutputPath = strrep(strOutputPath,'.bmp', '_fft2.bmp');
                    %imwrite(gabor3d, strOutputPath, 'bmp');
                    %disp(strOutputPath);
